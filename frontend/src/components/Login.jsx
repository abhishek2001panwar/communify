...
function Login() {
  ...
  const { login , isLoggedIn } = useAuth(); // Get the login function from your AuthContext
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // If successful, you can redirect the user or perform any other action
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-gray-100">
      <div className="w-full max-w-md p-8 space-y-8 bg-white rounded-lg shadow-md">
        ...
        <h2 className="text-2xl font-bold text-center text-gray-900">Login to Communify</h2>
          ...
          {/* <div className="flex items-center border-b border-gray-300">
            ...
            <div className="flex items-center border-b border-gray-300">
              ...
              <input
                ...
                onChange={handleChange}
                className="appearance-none rounded-none relative block w-full  px-3 py-2 border-none  text-gray-900 focus:outline-none  focus:z-10 sm:text-sm"
